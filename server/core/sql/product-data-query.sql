SELECT forsaljning.datum AS "date", matratt.namn_eng AS food_name, produkt.namn AS product_name, kundkategori.namn_eng AS customer_category, forsaljning.antal AS amount_sold, COALESCE(pebble.happy, -1) AS positive_feedback, COALESCE(pebble.sad, -1) AS negative_feedback
