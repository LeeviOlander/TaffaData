SELECT forsaljning.datum AS "date", produkt.namn AS product_name, kundkategori.namn_eng AS customer_category, forsaljning.antal AS quantity_sold, forsaljning.forsaljning AS revenue, COALESCE(pebble.happy, -1) AS positive_feedback, COALESCE(pebble.sad, -1) AS negative_feedback
